...
\begin{enumerate}
  ...
  \item \textbf{Phase 3: Intention Model Exploration (Stages 1--3)} \pending{Reconstructed dates: May--July 2026}. Developed flat sequence baselines, diagnosed metric calculation anomalies, implemented hierarchical dialogue transformers, and investigated last-turn gating and specialist routing.
  ...
  \item \textbf{Phase 5: Model Consolidation and E-Commerce Benchmarking} (Confirmed Git history: September 5--15, 2026). Deprecated modifier head (Pass 2), developed the Dual-Stream Antiphony architecture, synthesized the 700-dialogue negotiation benchmark, executed multi-task strategy ensemble searches, and conducted adversarial ablations.
...
\begin{figure}[htbp]
  ...
  \begin{ganttchart}[
    ...
    \ganttbar{3. Hierarchical Exploration \pending{Est.}}{2026-05}{2026-07} \\
    \ganttbar{4. Strategy Annotation (10.6k) \pending{Est.}}{2026-07}{2026-08} \\
    \ganttbar{5. Antiphony \& Benchmark Datagen}{2026-09}{2026-09} \\
...
\begin{itemize}
  ...
  \item \textbf{API Services for Synthetic Generation:} Paraphrasing and semantic verification leveraged free-tier and promotional credits for the Google Gemini API \pending{Total commercial API expenditure: under \$15, confirm exact billing ledger}.
\end{itemize}
\end{keypoint}
