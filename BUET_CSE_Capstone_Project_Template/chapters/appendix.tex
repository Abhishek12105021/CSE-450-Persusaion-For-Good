...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{lYYY}
    \toprule
    \textbf{Hyperparameter} & \textbf{Intention Models (v6--v14)} & \textbf{Strategy Encoders (v17/v18)} & \textbf{E-Commerce Transfer} \\
    \midrule
...
The tuned XGBoost stacking decision layer (evaluated in v18) performed grid search across 72 configurations:
\begin{itemize}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{lp{0.22\textwidth}p{0.32\textwidth}Y}
    ...
    \midrule
    \textbf{C7} & Stage Boundaries & Conflicting epoch definitions across prompts. & Standardized to 4 stages: 1 (v1--v5), 2 (v6--v9), 3 (v10--v13), 4 (v14). \\
    \midrule
    \textbf{C8} & Table B Thresholds & Mixed default ($0.8623$) and tuned ($0.8600$) scores. & Reported both numbers transparently; noted that v14 beats v13 under either rule. \\
    \midrule
