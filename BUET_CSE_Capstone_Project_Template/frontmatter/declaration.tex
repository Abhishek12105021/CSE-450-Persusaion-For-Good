...
``\ProjectTitle'', is the outcome of the engineering and research work carried out by us
...
\begin{tabular}{>{\raggedright\arraybackslash}p{0.45\textwidth} >{\raggedright\arraybackslash}p{0.45\textwidth}}
  ...
  Arnob Biswas (\pending{ID}) & Nawriz Ahmed Turjo (\pending{ID}) \\[15mm]
  \rule{0.4\textwidth}{0.4pt} & \rule{0.4\textwidth}{0.4pt} \\
  Abhishek Roy (\pending{ID}) & Monjur Hossain Khan (\pending{ID}) \\[15mm]
  \rule{0.4\textwidth}{0.4pt} & \\
  Shams Hossain Simanto (\pending{ID}) &
\end{tabular}
\clearpage
